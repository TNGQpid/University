...
def get_expected_format():
    ...
    expected_format = {'q1': 'TEXT_FORMAT',
                       ...
                       'q6': 'HTML_FORMAT',
                       'q7': 'TEXT_FORMAT',
                       'q8': 'TEXT_FORMAT_UNORDERED_LIST',
                       'q9': 'TEXT_FORMAT',
                       'q10': 'TEXT_FORMAT_ORDERED_LIST',
                       'q11': 'TEXT_FORMAT',
                       'q12': 'TEXT_FORMAT_UNORDERED_LIST',
                       'q13': 'TEXT_FORMAT',
                       'q14': 'TEXT_FORMAT',
                       'q15': 'TEXT_FORMAT_UNORDERED_LIST',
                       'q16': 'TEXT_FORMAT_UNORDERED_LIST',
                       'q17': 'TEXT_FORMAT_UNORDERED_LIST',
                       'q18': 'TEXT_FORMAT_DICT',
                       'q19': 'TEXT_FORMAT',
                       'q20': 'FILE_JSON_FORMAT'}
...
def get_expected_json():
    ...
    expected_json = {'q1': 98,
                     'q4': 20,
                     'q5': 87.10000000000001,
                     'q7': 'Ludwig Maximilian University of Munich',
                     'q8': ['Harvard University',
                            ...
                            'Dartmouth College'],
                     'q9': 'Tsinghua University',
                     'q10': ['Indian Institute of Science',
                             'Tata Institute of Fundamental Research',
                             'Indian Institute of Technology Bombay',
                             'Indian Institute of Technology Madras',
                             'University of Delhi'],
                     'q11': 1897,
                     'q12': ['Addis Ababa University',
                     ...
                     'q16': ['Rockefeller University',
                             'University of Paris',
                             'Rutgers University–New Brunswick',
                             'University of British Columbia',
                             'University of Washington - Seattle'],
                     'q17': ['United Kingdom', 'China', 'Germany', 'France'],
                     'q18': {'World Rank': '1',
...
def compare(expected, actual, q_format=TEXT_FORMAT):
    ...
    try:
        if SLASHES in q_format:
            ...
            if q_format == TEXT_FORMAT_ORDERED_LIST:
                if expected == sorted(expected):
                    expected = sorted(clean_slashes(expected))
                elif expected == sorted(expected, reverse=True):
                    expected = sorted(clean_slashes(expected), reverse=True)
                else: 
...
def clean_slashes(item):
    ...
    if isinstance(item, str):
        return type(item)(item.replace("\\", os.path.sep).replace("/", os.path.sep))
