...
REL_TOL = 0.05 #6e-04  # relative tolerance for floats
...
def get_expected_format():
    ...
    expected_format = {'q1': 'HTML_FORMAT_ORDERED',
                       'q2': 'HTML_FORMAT_ORDERED',
                       'q3': 'HTML_FORMAT_ORDERED',
                       'q4': 'HTML_FORMAT_ORDERED',
                       'q5': 'HTML_FORMAT_ORDERED',
                       'q6': 'HTML_FORMAT_ORDERED',
                       'q7': 'HTML_FORMAT_ORDERED',
                       'q8': 'HTML_FORMAT_UNORDERED',
                       'q9': 'HTML_FORMAT_UNORDERED',
                       'q10': 'HTML_FORMAT_UNORDERED',
                       'q11': 'TEXT_FORMAT',
                       'q12': 'TEXT_FORMAT',
                       'q13': 'HTML_FORMAT_ORDERED',
                       'q14': 'HTML_FORMAT_ORDERED',
                       'q15': 'HTML_FORMAT_ORDERED',
                       'q16': 'HTML_FORMAT_ORDERED',
                       'q17': 'HTML_FORMAT_UNORDERED',
                       'q18': 'HTML_FORMAT_UNORDERED',
                       'q19': 'TEXT_FORMAT',
                       'q20': 'HTML_FORMAT_ORDERED'}
