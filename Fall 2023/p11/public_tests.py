...
def get_expected_json():
    ...
    expected_json = {'q1': [219971.31454007205, 220096.7011785142, 220167.8343525934],
                     'q2': 0.000452112209723501,
                     'q3': -0.6256752095402645,
                     'q6': {'Red Giant': -0.025334640522875783,
                            'White Dwarf': 2.787333333333333,
                            'Neutron Star': 2.86},
                     'q10': ['broken_data\\other\\others.json'],
                     'q11': ['broken_data\\kepler\\100\\others.json',
                     ...
                     'q12': ['broken_data\\kepler\\10\\other\\others.json'],
